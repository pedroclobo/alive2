...
define void @f2(ptr %p, ptr %q) {
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %q, ptr %p, i64 2, i1 false)
  ret void
}

define void @f3(ptr %p, ptr %q) {
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %q, ptr %p, i64 4, i1 false)
  ret void
}

define void @f4(ptr %p, ptr %q) {
  call void @llvm.memcpy.p0i8.p0i8.i64(ptr %q, ptr %p, i64 8, i1 false)
  ret void
}
